...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div className="flex justify-around items-center">
        ...
        <div className="flex flex-row items-center">
          <div className="flex flex-row items-center">
            ...
            <p className="text-base font-medium tracking-normal leading-none text-center mr-2">
              Wish List
            </p>
          </div>
          <div
          ...
          <div className="flex flex-row items-center cursor-pointer pl-4">
            ...
            <div onClick={() => dispatch(logout())}>
              <Tooltip content="Sign Out" placemen="bottom">
      ...
      <div className="bg-black p-4 w-full flex item-center justify-center mx-auto">
        <p className="text-white text-base font-medium">50& OFF</p>
        <p className="text-white text-base font-medium mx-96">
